...
namespace NotSpotify.Controles
{
    public partial class BotonPlayList : UserControl
    {
        ...
        {
            Rectangle r = new Rectangle(0, 0, pbx_imagen.Width, pbx_imagen.Height);
            ...
            pbx_imagen.Region = new Region(gp);

            Rectangle r2 = new Rectangle(0, 0, pnl_backGround.Width, pnl_backGround.Height);
            ...
            pnl_backGround.Region = new Region(gp2);

            Rectangle r3 = new Rectangle(0, 0, pbx_play.Width, pbx_play.Height);
            ...
            pbx_play.Region = new Region(gp3);
